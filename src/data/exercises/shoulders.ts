...
export const shouldersExercises: ExerciseDefinition[] = [
  ...
  },
  {
    ...
    defaultReps: 10,
    media: {
      start: "/exercises/arnold-press/start.png",
      finish: "/exercises/arnold-press/finish.png",
      thumbnail: "/exercises/arnold-press/start.png",
    },
    progression: {
      minReps: 8,
      maxReps: 12,
    ...
    instructions: [
      "Sit upright holding dumbbells at chest height, palms facing you.",
      "Press up while rotating your palms to face forward.",
      "Finish with the dumbbells overhead, arms almost straight.",
      "Reverse the rotation on the way down.",
      "Return to the start with palms facing you again.",
    ],
    tips: [
      "Rotate smoothly through the whole press, not all at once at the top.",
      "Keep your ribs down — don't arch your lower back to finish the rep.",
      "The rotation adds front-delt work, so go lighter than a normal DB press.",
    ],
    mistakes: [
      "Rotating only at the very top or bottom.",
      "Leaning back and turning it into an incline press.",
      "Letting the elbows flare wide at the start position.",
    ],
    tags: ["press", "shoulders", "dumbbell", "compound"],
  },
  {
    id: "lateral-raise",
    name: "Lateral Raise",
