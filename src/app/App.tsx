    ...
    <div className="pb-8">
      ...
      <div className="px-5 pt-5">
        ...
        <div
          ...
          style={{ background: C.accentDim2, border: "1px solid rgba(204,242,50,0.15)" }}
        >
    ...
    <div className="pb-8">
      ...
      <div className="px-5">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(204,242,50,0.07) 0%, rgba(96,165,250,0.07) 100%)",
  ...
  if (loading)
    return (
      <div
        ...
        style={{
          background: `radial-gradient(ellipse 90% 40% at 50% -5%, rgba(204,242,50,0.08), transparent 60%), ${C.bg}`,
        }}
      >
        <p
          style={{
        ...
        style={
          isFullscreenDevice
            ? {
                width: "100vw",
                height: "100dvh",
                background: `radial-gradient(ellipse 90% 40% at 50% -5%, rgba(204,242,50,0.06), transparent 60%), radial-gradient(ellipse 70% 30% at 85% 110%, rgba(191,232,41,0.05), transparent 55%), ${C.bg}`,
              }
            : {
                width: 390,
                height: 844,
                ...
                borderRadius: 44,
                border: `1px solid ${C.border}`,
                boxShadow: `0 0 0 8px #111111, 0 60px 120px rgba(0,0,0,0.9), 0 0 80px rgba(204,242,50,0.04)`,
              }
        }
      >
        {!isFullscreenDevice && (
